...
class LoginController: UIViewController, CLLocationManagerDelegate{
  ...
  override func viewDidLoad() {
    ...
    self.showHideClaveBtn.customImageColor(color: nil, backgroundColor: .clear)
    self.showHideRegistroBtn.customImageColor(color: nil, backgroundColor: .clear)
    self.showHideConfirmClave.customImageColor(color: nil, backgroundColor: .clear)
    ...
    self.loginBackView.backgroundColor = Customization.viewBackgroundColor
    ...
    self.showPoliticasBtn.setTitleColor(.systemBlue, for: .normal)
    self.RegistroBtn.setTitleColor(.systemBlue, for: .normal)
    self.olvideClaveBtn.setTitleColor(.systemBlue, for: .normal)
