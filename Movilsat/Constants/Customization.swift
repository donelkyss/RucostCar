...
struct Customization {
  ...
  static var nameShowed: String = "Movilsat"
  static var logo: UIImage!
  static var primaryColor: UIColor = .white //#1f1f1f
  static var secundaryColor: UIColor = UIColor(red: 242/255, green: 203/255, blue: 17/255, alpha: 1)
  static var viewBackgroundColor: UIColor = secundaryColor
  ...
  static var buttonActionColor: UIColor = textColor
